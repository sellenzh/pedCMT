...
def main(args):
    ...
    with open(filename, 'a') as f:
        ...
        #lr = args.lr
        s = 'd_model: ' + str(d_model) + '\ndff: ' + str(dff) + '\nlayers: ' + str(layers) + '\ntimes_num: ' + str(times_num) + '\nbnks_layers: ' + str(bnks_layers) + '\nnum_bnks: ' + str(num_bnks) + '\n'
        #s = '\nbnks_layers: ' + str(bnks_layers) + '\nnum_bnks: ' + str(num_bnks) + '\n'
        #s = 'lr: ' + str(lr) +'\nnum_bnks: ' + str(num_bnks) + '\n'
        #st, ed = args.sta_f, args.end_f
        #s = 'start_frame :' + str(st) + '\n' + 'end_frame :' + str(ed) + '\n'
        f.write(s)
        accp = '\nAcc:' + str(acc * 100) + '---' + '\nF1:' + str(f1 * 100) + '---' + '\npre:' + str(pre_s * 100) + '---' + '\nRec:' + str(recall_s * 100) + '---' + '\nAUC:' + str(auc * 100) + '---' + '\nmatrix:' + str(matrix) + '---'
        shift_line = '\n\n'
        f.write(accp)
        f.write(shift_line)
